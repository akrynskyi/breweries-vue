    ...
    <div class="wrapper">
      ...
      >
        ...
        <div class="card__content">
          <p>Country: <span>{{ item.country || 'Unknown' }}</span></p>
          <p>State: <span>{{ item.state || 'Unknown' }}</span></p>
          <p>City: <span>{{ item.city || 'Unknown' }}</span></p>
          <p>Street: <span>{{ item.street || 'Unknown' }}</span></p>
          <p>Phone: <span>{{ item.phone || 'Unknown' }}</span></p>
        </div>
      </div>
    </div>
  </section>
